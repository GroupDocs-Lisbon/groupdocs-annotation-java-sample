    ...
    <body>
        ...
        <nav class="navbar navbar-default">
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav"><li><h2>Create annotation</h2></li></ul>
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <form:form commandName="annotation" action="addAnnotation?fileId=${fileId}" class="form-horizontal" method="post">        
            <div class="input-group col-sm-offset-1">
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" path="FontColor" id="FontColor"/>
                    </div>
                    <div class="form-group">
