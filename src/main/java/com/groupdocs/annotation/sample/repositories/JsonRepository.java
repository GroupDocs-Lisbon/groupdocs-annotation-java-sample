package com.groupdocs.annotation.sample.repositories;
 ...
 */
public abstract class JsonRepository<TEntity extends IEntity> extends JsonFile<List<TEntity>> implements IRepository<TEntity> {
    ...
    public void commit() {
        try {
            ...
            Logger.getAnonymousLogger().log(Level.SEVERE, String.format("Unable to commit changes: %s", _entityName), e);
        }
    }
    ...
    public void refresh(TEntity entity) {
        try {
            ...
            Logger.getAnonymousLogger().log(Level.SEVERE, String.format("Unable to refresh changes: %s", _entityName), e);
        }
    }
    ...
    public boolean add(TEntity entity) {
        synchronized (_syncRoot) {
            try {
                ...
                Logger.getAnonymousLogger().log(Level.SEVERE, String.format("Unable to add entity: %s", _entityName), e);
            }
        }
        return true;
    }
    ...
    public boolean remove(TEntity entity) {
        synchronized (_syncRoot) {
            try {
                ...
                Logger.getAnonymousLogger().log(Level.SEVERE, String.format("Unable to remove entity: %s", _entityName), e);
            }
        }
        return false;
    }
    ...
    public boolean update(TEntity entity) {
        synchronized (_syncRoot) {
            try {
                ...
                Logger.getAnonymousLogger().log(Level.SEVERE, String.format("Unable to update entity: %s", _entityName), e);
            }
        }
        return true;
    }
    ...
    public boolean add(List<TEntity> entities) {
        synchronized (_syncRoot) {
            try {
                ...
                Logger.getAnonymousLogger().log(Level.SEVERE, String.format("Unable to add entities: %s", _entityName), e);
            }
        }
        return true;
    }
    ...
    public boolean remove(List<TEntity> entities) {
        synchronized (_syncRoot) {
            try {
                ...
                Logger.getAnonymousLogger().log(Level.SEVERE, String.format("Unable to remove entities: %s", _entityName), e);
            }
        }
        return true;
    }
    ...
    public boolean update(List<TEntity> entities) {
        synchronized (_syncRoot) {
            try {
                ...
                Logger.getAnonymousLogger().log(Level.SEVERE, String.format("Unable to update entities: %s", _entityName), e);
            }
        }
        return true;
    }
